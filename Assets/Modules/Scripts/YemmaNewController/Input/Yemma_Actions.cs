...
//     version 1.14.1
//     from Assets/Modules/Scripts/YemmaNewController/Input/Yemma_Actions.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Modules/Scripts/YemmaNewController/Input/Yemma_Actions.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @Yemma_Actions: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    ~@Yemma_Actions()
    {
        UnityEngine.Debug.Assert(!m_YemmaKeyboard.enabled, "This will cause a leak and performance issues, Yemma_Actions.YemmaKeyboard.Disable() has not been called.");
    }
    ...
    {
        private @Yemma_Actions m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public YemmaKeyboardActions(@Yemma_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
